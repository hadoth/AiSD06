...
//    }
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            System.out.println(Arrays.toString(Strategy.SHELL1.getStrategy(listToSort).toArray()));
            System.out.println(Arrays.toString(Strategy.PAPERNOV.getStrategy(listToSort).toArray()));
